      ...
      <Container>
        ...
        <Row className="mb-3">
          <Col md={12} className="p-0 image-container" style={{}}>
              ...
              <Image src={HotelImage} width="100%" height="700px" className="img" style={{marginTop:'-177px' , visibility:'visible'}}></Image>
        ...
        <Row className="mb-3 images">
          ...
          <Col md={4} className="bg-success d-flex flex-column justify-content-center align-items-center text-justify" >
            <text className="text-white text-justify" style={{ fontSize: '21px' , width:'95%' }}>Welcome to The Lake Hotels, where luxury meets tranquility. Immerse yourself in a serene oasis nestled by picturesque lakes, offering a seamless blend of comfort and sophistication.</text>
        ...
        <Row className="mb-3">
          <Col md={4} className="bg-success d-flex flex-column justify-content-center align-items-center text-justify">
            <text className="text-white text-justify" style={{ fontSize: '21px' , width:'95%' }}>Nipponzan Myohoji Buddhist Temple, a serene sanctuary in the heart of Kolkata, invites you to experience the essence of peace and spirituality. Adorned with intricate architecture and lush gardens, this renowned temple offers a tranquil retreat for reflection and meditation, embracing the teachings of Buddhism.</text>
